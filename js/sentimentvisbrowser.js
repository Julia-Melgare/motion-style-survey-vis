...
function renderLollipopChart(){
	...
	.append("line")
		...
		.attr("y1", function(d) { return lollipopChartYScale(d.text) + 0.1; })
		.attr("y2", function(d) { return lollipopChartYScale(d.text) + 0.1; })
		.attr("stroke", "grey")
	...
	.attr("cy", function(d) { return lollipopChartYScale(d.text) + 0.1; })
	.attr("r", "4")
	.style("fill", "#17becf")
